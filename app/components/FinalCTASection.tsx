...
export default function FinalCTASection() {
  ...
  return (
    <section style={{
      background: 'linear-gradient(160deg, #1C1008 0%, #2A1A0C 50%, #1C1008 100%)',
      padding: '96px 24px',
      position: 'relative',
      overflow: 'hidden',
    }}>
      ...
      <div style={{ maxWidth: 560, margin: '0 auto', textAlign: 'center', position: 'relative' }}>
        ...
        >
          ...
          <br />
          <strong style={{ color: '#D4B89A' }}>בחינם וללא התחייבות</strong>{' '}
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 14 }}>
            ...
            <p style={{ fontSize: 12, color: '#554848' }}>תישלח ישירות לוואטסאפ שלי</p>
          </div>
        </motion.form>
        ...
        <motion.p
          ...
          style={{ fontSize: '0.93rem', fontStyle: 'italic', color: '#4A3028' }}
        >
