...
const items = [
  {
    main: 'את רוצה לרדת במשקל ולא לחזור אחורה — וכבר ניסית דיאטות, שיטות, השראה וימי ראשון עם כוונות.',
    sub: 'אבל המשקל חוזר, ואת ממשיכה להרגיש שהתזונה גוזלת ממך אנרגיה במקום להחזיר אותה.',
  },
  {
